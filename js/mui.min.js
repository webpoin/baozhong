		...
		if (u.setRequestHeader = s, u.onreadystatechange = function() {
				if (4 === u.readyState) {
					...
					if (u.status >= 200 && u.status < 300 || 304 === u.status || 0 === u.status && "file:" === t) {
						try {
							"script" === h ? (1, eval)(b) : "xml" === h ? b = u.responseXML : "json" === h && (b = i.test(b) ? null : a.parseJSON(u.responseText))
...
// 选择器补丁
HTMLElement.prototype.closest = HTMLElement.prototype.closest || function(selector) {

	var the = this;
	var arrcall = Array.prototype.slice;
	var tarname = the.tagName.toLocaleLowerCase();

	// 0个或1个结果
	return arrcall.call(document.querySelectorAll(selector)).filter(function(i){
		return arrcall.call(i.querySelectorAll(tarname)).filter(function(i2){return i2 == the;}).length >0;
	})[0];
...
// 返回
mui.back = function() {plus.webview.currentWebview().close('slide-out-right',300);};
mui('body').on('tap', '.toback', function(e) {mui.back();});
...
mui(document).on('tap','a',function(){
	...
	if(!href){return;}
	if(id){req.viewId = id;}
	if(href.indexOf('line.html') == 0){req.viewId = 'line'}
...
// // 测试用数据
// !function(){
// 	// window.plus = {networkinfo:{getCurrentType:function(){return 3;}}};
// 	var script = document.createElement('script');
// 	var getDate = function(obj){

// 		if(window.demo){
// 			var data = demo[JSON.parse(obj.data).type];
// 			obj.success(data);
// 		} 
// 		!window.demo && setTimeout(function(){getDate(obj)},100);
// 	}
// 	script.src = '../js/demo.js';
// 	document.body.appendChild(script);
// 	mui.ajax = function(url,obj){getDate(obj);}	


// 	mui.plusReady = function(cb){
// 		window.plus = window.plus || {}

// 		window.plus.screen = {lockOrientation:function(){}};
// 		window.plus.navigator = {closeSplashscreen:function(){}};

// 		window.plus.networkinfo = {getCurrentType:function(){}}
